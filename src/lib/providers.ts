...
import { applyProviderMode } from '@/lib/provider-mode';

/** All supported provider types with UI metadata */
const FULL_PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  {
    id: 'anthropic',
    name: 'Anthropic',
    icon: '🤖',
...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = applyProviderMode(FULL_PROVIDER_TYPE_INFO);
