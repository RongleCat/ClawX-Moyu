...
interface PreinstalledMarker {
    source: 'onekeyclaw-preinstalled';
    slug: string;
    version: string;
    installedAt: string;
}
...
/**
 * Built-in skills bundled with OneKeyClaw that should be pre-deployed to
...
const PREINSTALLED_MARKER_NAME = '.onekeyclaw-preinstalled.json';
