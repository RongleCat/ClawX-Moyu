...
if /i "%1"=="update" (
    echo openclaw is managed by OneKeyClaw ^(bundled version^).
    echo.
    echo To update openclaw, update OneKeyClaw:
    echo   Open OneKeyClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=OneKeyClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\OneKeyClaw.exe" "%OPENCLAW_ENTRY%" %*
)
